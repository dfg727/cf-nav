-- Seed h5 sites, scoped to categories nested under the canonical h5 root (see 02.seed_h5_categories.sql).
-- Category lookups are parent-scoped because names like '常用'/'杂类' also exist as unrelated
-- top-level categories migrated under the 'other' root in 01.migrated_legacy_data.sql.
...
SELECT
  (SELECT id FROM categories WHERE name = '常用' AND pid = (SELECT id FROM categories WHERE name = 'h5' AND pid IS NULL LIMIT 1) LIMIT 1),
  '今日热榜官网',
...
INSERT INTO sites (category_id, name, url, description, icon, status, is_public, sort_order, created_at, updated_at)
SELECT
  (SELECT id FROM categories WHERE name = '涨姿势' AND pid = (SELECT id FROM categories WHERE name = 'h5' AND pid IS NULL LIMIT 1) LIMIT 1),
  '莫问导航',
  'https://mwdh.cc/',
  '',
  NULL,
...
INSERT INTO sites (category_id, name, url, description, icon, status, is_public, sort_order, created_at, updated_at)
SELECT
  (SELECT id FROM categories WHERE name = '娱乐' AND pid = (SELECT id FROM categories WHERE name = 'h5' AND pid IS NULL LIMIT 1) LIMIT 1),
  'NBA直播',
...
INSERT INTO sites (category_id, name, url, description, icon, status, is_public, sort_order, created_at, updated_at)
SELECT
  (SELECT id FROM categories WHERE name = '工具' AND pid = (SELECT id FROM categories WHERE name = 'h5' AND pid IS NULL LIMIT 1) LIMIT 1),
  '1Panel',
...
INSERT INTO sites (category_id, name, url, description, icon, status, is_public, sort_order, created_at, updated_at)
SELECT
  (SELECT id FROM categories WHERE name = '杂类' AND pid = (SELECT id FROM categories WHERE name = 'h5' AND pid IS NULL LIMIT 1) LIMIT 1),
  '福利吧地址发布页',
...
INSERT INTO sites (category_id, name, url, description, icon, status, is_public, sort_order, created_at, updated_at)
SELECT
  (SELECT id FROM categories WHERE name = 'LanYang' AND pid = (SELECT id FROM categories WHERE name = 'h5' AND pid IS NULL LIMIT 1) LIMIT 1),
  '登录 [Jenkins]',
